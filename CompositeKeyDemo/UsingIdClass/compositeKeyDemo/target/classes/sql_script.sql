...
create table cusomer_loan(customer_id int references customer(customer_id), loan_id int references loan(loan_id), eligible_amount double, availed_Amount double, tenure_in_years int, primary key(customer_id, loan_id));
