...
//		this.loanId = loanId;
		this.customerLoanPk = new CustomerLoanPk(customerId,loanId);
...
//	}
	...
	public String toString() {
		return "CustomerLoan [customerId=" + customerLoanPk.getCustomerId() + ", loanId=" + customerLoanPk.getLoanId() + ", eligibleAmount=" + eligibleAmount
